...
const Map = () => {
  return (
    <>
     <div className='lg:bg-bgMap lg:bg-no-repeat lg:bg-cover lg:bg-center w-full'>
        <div className='container mx-auto block lg:flex lg:justify-center lg:items-center lg:py-[64px]' id='comittees'>
